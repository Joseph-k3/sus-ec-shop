// データベースのテーブル構造を確認するスクリプト
import { createClient } from '@supabase/supabase-js'

const supabaseUrl = 'https://hcqgfdyentwazmyikvtl.supabase.co'
const supabaseKey = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImhjcWdmZHllbnR3YXpteWlrdnRsIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NTI1ODcxNzYsImV4cCI6MjA2ODE2MzE3Nn0.cVlLktBIpOEGRJygkJyMZQGGT2xtryd6vsPO1tKbAlE'
